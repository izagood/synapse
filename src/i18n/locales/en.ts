...
export const en: LocaleShape<KoMessages> = {
  ...
  start: {
    ...
    recentEmpty: "No folders opened yet",
  ...
  fileTree: {
    ...
    deleteFilePrompt: "Move {name} to trash?",
    deleteFolderPrompt: "Move the folder {name} and all files inside to trash?",
    deleteHint:
      "Items are automatically deleted after 30 days. You can empty the trash in Settings. Press Enter to move now.",
    dontAskDelete: "Move to trash without asking again",
  ...
  settings: {
    ...
    deleteWarning: "Items will be moved to trash immediately. They will be automatically deleted after 30 days.",
    sync: "Sync",
    autoSync: "Auto Sync",
  ...
  update: {
    ...
    availableVersion: "Update v{version} available",
  ...
  editor: {
    ...
    legacyFrontmatterWarning:
      "This document uses the legacy frontmatter format (a blank line after ---). Editing it in rich text can turn the YAML into a heading. Remove that blank line in source mode to fix it.",
  ...
  graph: {
    ...
    groupQueryPlaceholder: "tag:x · path:folder/ · name",
    display: "Display",
    nodeScale: "Node size",
    linkThickness: "Link thickness",
    forces: "Forces",
    repulsion: "Repel force",
